...
if ("serviceWorker" in navigator) navigator.serviceWorker.register(require("711e2ff6ae51f962")).then((reg)=>console.log("service worker registered")).catch((err)=>console.log("service worker not registered", err));

},{"711e2ff6ae51f962":"ccCps"}],"ccCps":[function(require,module,exports) {
module.exports = require("5b32fdcf3bede741").getBundleURL("1G2bZ") + "sw.js" + "?" + Date.now();

},{"5b32fdcf3bede741":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["hPIHA","igcvL"], "igcvL", "parcelRequirebf73")
